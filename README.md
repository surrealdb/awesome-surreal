...
- [surreal-board](https://github.com/diebugger-tech/kanban) - Zero-backend realtime Kanban board powered by SurrealDB WebSocket. Terminal dark theme, drag & drop, inline editing, NixOS compatible.
