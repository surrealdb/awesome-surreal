...
- [MECOMP](https://github.com/AnthonyMichaelTDM/mecomp) - A local music player that uses surrealdb as the backend, features song similarity searchs ("play songs similar to ..."), song clustering, and other fun things.
