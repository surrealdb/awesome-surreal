...
- [SurrealDb.Net.Design](https://github.com/surrealdb/surrealdb) - An design-time CLI or via [Nuget](https://www.nuget.org/packages/SurrealDb.Net.Design) for generating C# record models from a SurrealDB database schema. 
