...
- [mylk](https://github.com/ri-nat/mylk) - Ruby client library with support for both HTTP and WebSocket transports.
...
- [surrealdb_flutter](https://github.com/duhanbalci/surrealdb_flutter) - SurrealDB client for Dart and Flutter.
- [surrealdb.cr](https://github.com/yorci/surrealdb.cr) - The unofficial SurrealDB client library for Crystal.
